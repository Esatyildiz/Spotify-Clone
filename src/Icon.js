const HomeIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
const SearchIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} className="Svg-sc-ytk21e-0 uPxdw search-icon" viewBox="0 0 24 24" fill="currentColor">
...
const DeviceIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} aria-hidden="true" viewBox="0 0 16 16" fill="currentColor">
...
const VolumeMutedIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} aria-hidden="true" aria-label="playback-control.a11y.volume-off" viewBox="0 0 16 16" fill="currentColor">
...
const VolumeLowIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} aria-hidden="true" aria-label="playback-control.a11y.volume-low" id="volume-icon" viewBox="0 0 16 16" fill="currentColor">
...
const VolumeNormalIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} aria-hidden="true" aria-label="playback-control.a11y.volume-medium" id="volume-icon" viewBox="0 0 16 16" fill="currentColor">
...
const VolumeFullIcon = ({ size }) => {
    return (
        <svg role="presentation" height={size} width={size} aria-hidden="true" aria-label="playback-control.a11y.volume-high" id="volume-icon" viewBox="0 0 16 16" fill="currentColor">
            <path d="M9.741.85a.75.75 0 01.375.65v13a.75.75 0 01-1.125.65l-6.925-4a3.642 3.642 0 01-1.33-4.967 3.639 3.639 0 011.33-1.332l6.925-4a.75.75 0 01.75 0zm-6.924 5.3a2.139 2.139 0 000 3.7l5.8 3.35V2.8l-5.8 3.35zm8.683 4.29V5.56a2.75 2.75 0 010 4.88z" />
...
const ArrowleftIcon = ({ size }) => {
    return (
        <svg role="img" height={size} width={size} aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" fill="currentColor">
